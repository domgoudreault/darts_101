  ...
  switch (AppDisplay.displayMode) {
    ...
    case DisplayMode.display10CompactPhone:
      return ImageCardFrameConfig(        
        assetPath: 'assets/png/mechanics/player_card_frame_175x256.png',
        renderWidth: 175,
        renderHeight: 256,
      );
    case DisplayMode.display15MediumTablet:
      return ImageCardFrameConfig(        
        assetPath: 'assets/png/mechanics/player_card_frame_350x512.png',
        renderWidth: 350,
        renderHeight: 512,
      );
    case DisplayMode.display20LargeLapDesk:
      return ImageCardFrameConfig(        
        assetPath: 'assets/png/mechanics/player_card_frame_525x768.png',
        renderWidth: 525,
        renderHeight: 768,
      );
    case DisplayMode.display25Ultra4K:
      return ImageCardFrameConfig(        
        assetPath: 'assets/png/mechanics/player_card_frame_700x1024.png',
        renderWidth: 700,
        renderHeight: 1024,
      );
  }
...
ImageConfig getCarouselPlayerImageConfig(bool isAdminSys, String avatarCode) {
  switch (AppDisplay.displayMode) {
    case DisplayMode.display05SmallPhone:
    case DisplayMode.display10CompactPhone:
      return ImageConfig(        
